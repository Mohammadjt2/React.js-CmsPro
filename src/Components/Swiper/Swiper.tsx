    ...
    >
      <SwiperSlide>
        ...
        <p className="italic py-1">
          ...
          سطرآنچنان که لازم است و برای شرایط فعلیتکنولوژی مورد نیاز و کاربردهای
      ...
      <SwiperSlide>
        ...
        <p className="italic py-1">
          لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده
          از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و می باشد.
        </p>
      </SwiperSlide>
      <SwiperSlide>
        <h2 className="font-bold py-1">
        ...
        <p className="italic py-1">
          لورم ایپسوم متن ساختگی با تولید فعلیتکنولوژی مورد نیاز و کاربردهای
          متنوع با هدف بهبود ابزارهای کاربردی می باشد.
        </p>
      </SwiperSlide>
      <SwiperSlide>
      ...
      <SwiperSlide>
        ...
        <p className="italic py-1">
          لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده
          از طراحان گرافیک است ابزارهای کاربردی می باشد.
        </p>
      </SwiperSlide>
    </Swiper>
  );
